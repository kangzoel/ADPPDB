...
public class SMP {
    ...
    private String batasPenerimaan;
    private String alamatJalan;

    public SMP(String id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                setBatasPenerimaan(rs.getString("batas_penerimaan"));
    ...
    public String getBatasPenerimaan() {
        return batasPenerimaan;
    }

    public void setBatasPenerimaan(String batasPenerimaan) {
        this.batasPenerimaan = batasPenerimaan;
    }
    ...
    public void aturSekolah(int idOperator) {
        try {
            String sql = "UPDATE smp set kecamatan = ? , npsn = ? , nama = ? , status = ? , batas_penerimaan = ? , alamat_jalan = ? WHERE id = ? ";
            PreparedStatement stmt = JDBCAdapter.getConnection()
                    .prepareStatement(sql);
            stmt.setString(1, getKecamatan());
            stmt.setString(2, getNpsn());
            stmt.setString(3, getNama());
            stmt.setString(4, getStatus());
            stmt.setString(5, getBatasPenerimaan());
            stmt.setString(6, getAlamatJalan());
            stmt.setInt(7, idOperator);
